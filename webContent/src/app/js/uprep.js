...
(function(window, $) {
    ...
    uPREP.LOAD_SERVICE_SCRIPT = [
        uPREP.SERVICE.REGISTRATION
        ,uPREP.SERVICE.RESERVATION
    ];

    uPREP.START_SERVICE = uPREP.SERVICE.REGISTRATION;
    ...
    uPREP.getRegistration = function() {
        return uPREP[uPREP.SERVICE.REGISTRATION];
    };

    uPREP.getReservation = function() {
        return uPREP[uPREP.SERVICE.RESERVATION];
    };
